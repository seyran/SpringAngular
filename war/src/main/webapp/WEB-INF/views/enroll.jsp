...
<head>
    <meta http-equiv="Content-Type" text="text/html; charset=ISO-8859-1">
    ...
    <form:form method="POST" modelAttribute="student" class="form-horizontal">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <name class="col-md-3 control-lable" for="firstName">First Name</name>
                <div class="col-md-7">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <name class="col-md-3 control-lable" for="lastName">Last Name</name>
                <div class="col-md-7">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <name class="col-md-3 control-lable" for="sex">Sex</name>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <name class="col-md-3 control-lable" for="dob">Date of birth</name>
                <div class="col-md-7">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <name class="col-md-3 control-lable" for="email">Email</name>
                <div class="col-md-7">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <name class="col-md-3 control-lable" for="section">Section</name>
                <div class="col-md-7" class="form-control input-sm">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <name class="col-md-3 control-lable" for="country">Country</name>
                <div class="col-md-7">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <name class="col-md-3 control-lable" for="firstAttempt">First Attempt ?</name>
                <div class="col-md-1">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <name class="col-md-3 control-lable" for="subjects">Subjects</name>
                <div class="col-md-7">
